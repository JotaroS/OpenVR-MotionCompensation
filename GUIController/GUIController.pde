...
String[] l_interactions = {"go-go", "go-go-with-accel", "saber", "gamepad-boxing", "gamepad-saber", "deactivate"};
//
...
JSONObject setObject() {
  ...
  json.setFloat("stick_sens", cp5.getController("stick_sens").getValue());
...
void setObject(JSONObject json) {
  ...
  cp5.getController("saber_rot").setValue(json.getFloat("saber_rot"));
  cp5.getController("stick_sens").setValue(json.getFloat("stick_sens"));
